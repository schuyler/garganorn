...
These tests verify the SQL logic used by garganorn/stages.py's
stage_import (garganorn/sql/osm_import.sql) and the osmium pre-filter
stage in scripts/extract-osm-parquet.sh.
...
# ---------------------------------------------------------------------------
# Shared SQL fragments (mirrors garganorn/sql/osm_import.sql)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Test: osmium pre-filter stage in extract-osm-parquet.sh
# ---------------------------------------------------------------------------
