    ...
    def _create_division_parquet(self):
        ...
        self.con.execute(f"""
            COPY (
                SELECT
                    'test_div_1' AS id,
                    row('Test Division', map_from_entries([('en', 'Test Division')]), []::STRUCT(language VARCHAR, value VARCHAR, variant VARCHAR)[])::STRUCT("primary" VARCHAR, common MAP(VARCHAR, VARCHAR), rules STRUCT(language VARCHAR, value VARCHAR, variant VARCHAR)[]) AS names,
                ...
                SELECT
                    'test_div_2' AS id,
                    row('Test Division 2', map_from_entries([('en', 'Test Division 2')]), []::STRUCT(language VARCHAR, value VARCHAR, variant VARCHAR)[])::STRUCT("primary" VARCHAR, common MAP(VARCHAR, VARCHAR), rules STRUCT(language VARCHAR, value VARCHAR, variant VARCHAR)[]) AS names,
                    'locality'::VARCHAR AS subtype,
                    'US'::VARCHAR AS country,
                ...
                SELECT
                    'test_div_3' AS id,
                    row('Test Division 3', map_from_entries([('en', 'Test Division 3')]), []::STRUCT(language VARCHAR, value VARCHAR, variant VARCHAR)[])::STRUCT("primary" VARCHAR, common MAP(VARCHAR, VARCHAR), rules STRUCT(language VARCHAR, value VARCHAR, variant VARCHAR)[]) AS names,
                    'locality'::VARCHAR AS subtype,
                    'US'::VARCHAR AS country,
