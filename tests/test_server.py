...
def test_get_record_with_boundaries_includes_relations():
    ...
    mock_boundaries.containment.return_value = [
        {"collection": "org.atgeo.places.overture.division", "rkey": "85922583"},
    ]
    ...
    assert value["relations"]["within"][0]["collection"] == "org.atgeo.places.overture.division"
    assert value["relations"]["within"][0]["rkey"] == "85922583"
