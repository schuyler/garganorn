...
| [design-constraints.md](design-constraints.md) | Non-trivial implications of the design requirements and the implementation choices together — consequences neither states on its own |
