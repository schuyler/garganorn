...
| [overlap-tile-references-design.md](overlap-tile-references-design.md) | Referencing each division from every tile its extent reaches, replacing the single interior point (shipped) |
